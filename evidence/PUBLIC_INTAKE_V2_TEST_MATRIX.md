...
`npm test` — **464 pass, 10 skipped** (baseline trước đợt này: 266 pass). Không test nào bị vô
hiệu hóa hay đánh dấu skip để đi qua.
...
| `tests/officer-assisted-intake.test.ts` | 16 | Client không forge được nhãn `OFFICER_ASSISTED` |
...
| Bảy kịch bản E2E §17.3 | Như trên | Trước khi merge |
