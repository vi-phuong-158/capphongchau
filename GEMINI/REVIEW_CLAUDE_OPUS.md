...
Yêu cầu nghiệp vụ mới nói rõ: *"cán bộ được chỉnh sửa toàn bộ trường của bản làm việc"*, *"thêm, sửa, xóa, sắp xếp thửa đất"*, *"thêm, sửa, xóa mục đích sử dụng"*. Đây là **hạng mục lớn nhất chưa có** trong repo, và cũng là thứ AI phục vụ — AI đọc ra 20 thửa mà cán bộ không sửa được thửa nào thì kết quả AI không dùng được.
...
| §2.2 "Dữ liệu cấu trúc ban đầu có thể rỗng hoặc tối thiểu", §1.2 "người dân chỉ chụp ảnh" | **Mâu thuẫn với quyết định mới nhất** trong prompt §4.1: *"Người dân vẫn trực tiếp điền thông tin hồ sơ"* | **SỬA.** Người dân vẫn kê khai đủ như hiện tại. AI đọc ảnh để **đối chiếu**, không để thay người dân nhập |
