...
export const PUBLIC_SHEET_DEFINITIONS: readonly SheetDefinition[] = [
  {
    ...
    headers: [
      ...
      "updated_at",
      "draft_json",
      // Gói A: nối cuối để không dịch 19 cột đã có dữ liệu.
      "access_version",
      "file_summary_json",
    ],
  },
  ...
  },
  {
    ...
    headers: [
      ...
      // Nhóm "Người sử dụng đất hiện tại" của PL3 (O, P, 14, 15) — nối cuối để không dịch cột cũ.
      "has_distinct_current_user",
      "current_user_name",
  ...
  {
    title: "PUBLIC_SUPPLEMENT_REQUESTS",
    headers: [
      "request_id",
      "submission_id",
      "status",
  ...
  {
    title: "EXISTING_CERTIFICATE_OWNERS",
    headers: [
      "link_id",
      "existing_record_id",
      "citizen_id_hmac",
  ...
  {
    title: "PUBLIC_EXISTING_RECORD_LINKS",
    headers: [
      "link_id",
      "submission_id",
      "owner_id",
  ...
  {
    // 256 cột bucket theo byte đầu HMAC. Mỗi lookup chỉ đọc đúng một cột.
    title: "PUBLIC_LOOKUP_INDEX",
