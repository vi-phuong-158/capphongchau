...
export const GCN_V2_FIELD_CONTRACT = [
  ...
  {
    path: "registeredChanges[].confirmedDate",
    label: "Ngày xác nhận biến động",
    valueType: "string",
    officerForm: true,
    completionCheck: false,
    pl3Columns: "Không xuất trực tiếp",
    ...
    aiApply: "REVIEW_ONLY",
    requiredAtCompletion: false,
    note: "Chỉ hiển thị để đối chiếu; không tự sửa dữ liệu gốc.",
  },
  {
    path: "registeredChanges[].content",
    ...
    aiApply: "REVIEW_ONLY",
    requiredAtCompletion: false,
    note: "Chỉ hiển thị để đối chiếu; không tự sửa dữ liệu gốc hay lý do thay đổi.",
  },
  {
    path: "registeredChanges[].confirmedBy",
    label: "Cơ quan xác nhận biến động",
    valueType: "string",
    officerForm: true,
    completionCheck: false,
    pl3Columns: "Không xuất trực tiếp",
